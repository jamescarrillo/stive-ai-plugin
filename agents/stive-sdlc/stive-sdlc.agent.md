...
**Aceptas:**
- `init` / `"configura"` / `"inicializa stive"` → configurar el proyecto y crear carpetas (aplica el skill `init`; también disponible como `/stive-ai:init`)
